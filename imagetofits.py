...
cts.exportfits(imagename='/mnt/work/work/HI_DATA/blcal_test/RGG5_cube_14kmps/uvran_0.5~5klambda.image', fitsimage="../blcal_test/RGG5_finalcube_5lkambda.fits", dropstokes = True, velocity = True)
